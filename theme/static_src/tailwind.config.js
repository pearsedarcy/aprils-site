    ...
    theme: {
        ...
        extend: {
          ...
          colors: {
            ...
            system: {
              "success-green": '#12C998',
              "success-green-light": '#16FFBD',
              "error-red": '#c34271',
              "error-red-light": '#F070A1',
            },
            background: {
              DEFAULT: '#ffffff',
              primary: '#ffffff',
              secondary: '#F070A1',
              tertiary: '#c34271',
              alternative: '#439F76', // Changed from #12C998 to darker green for better contrast
              success: '#16FFBD',
              error: '#F070A1',
            },
            text: {
              ...
              primary: '#c34271',
              secondary: '#439F76',
              alternative: '#ffffff', // Changed to white for better contrast on dark backgrounds
              success: '#12C998',
              error: '#c34271',
            },
            link: {
